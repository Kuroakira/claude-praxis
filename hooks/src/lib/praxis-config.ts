...
const DEFAULT_GLOBAL_LEARNINGS_PATH = path.join(
  homedir(),
  ".claude",
  "learnings",
  "global-learnings.md",
...
function resolveConfigPath(cwd: string, rawPath: string): string {
...
export function loadPraxisConfig(cwd: string): PraxisConfig {
