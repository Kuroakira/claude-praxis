...
export function appendSkillMarker(markerDir, sessionId, skillName) {
    fs.mkdirSync(markerDir, { recursive: true });
    fs.appendFileSync(path.join(markerDir, sessionId), skillName + "\n");
}
export function hasSkill(markerDir, sessionId, skillName) {
...
export function touchMarker(markerPath) {
    fs.mkdirSync(path.dirname(markerPath), { recursive: true });
    fs.writeFileSync(markerPath, "");
}
export function cleanSessionMarkers(markerDir, sessionId) {
