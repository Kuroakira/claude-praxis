...
try {
    ...
    process.stderr.write(`Task completion blocked for: ${taskSubject}. Run verification (typecheck, lint, test) and include output before marking this task complete.\n`);
    process.exit(2);
}
catch {
    process.exit(0);
