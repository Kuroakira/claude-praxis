...
| `research_context` | No | Findings from prior research phase (in `/design` workflow). When absent (e.g., in `/plan`), analysis relies solely on codebase scanning without external research context |
...
- **Invoked by**: `commands/analyze.md`, `commands/design.md`, `commands/plan.md`
