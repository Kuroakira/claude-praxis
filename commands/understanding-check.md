...
This is a standalone command. Run it after completing a workflow (`/feature-spec`, `/design`, `/investigate`) to verify you can explain the key decisions — not just approve them.
...
If material is sufficient, proceed to Phase 2. If insufficient, explain why — the remedy is running the original workflow with more explicit decision recording.
...
### Next Phase
→ Run /claude-praxis:eval to improve framework from this session?
```
